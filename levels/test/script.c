...
const LevelScript level_test_entry[] = {
	...
	AREA(1, test_area_1),
		...
		REGION_OBJECT(-395.175537109375, -1553.2607421875, 5260.14306640625,
			-8.109279005155123e-06, 45.00000125223908, 0.0,
			/*BPARAM1*/ 0,
			/*BPARAM2*/ 0,
			/*BPARAM3*/ 0,
			/*BPARAM4*/ 0,
			/*MODEL ID*/ MODEL_STAR,
			/*BEHAVIOR*/ bhvStaticObject,
			/*Event*/ NULL),
		OBJECT(MODEL_NONE, 1846, -2153, -1345, 0, -104, 0, 0x00000000, bhvNPC),
		OBJECT(MODEL_NONE, 1846, -2153, -1672, 0, -65, 0, (1 << 16), bhvNPC),
		REGION_OBJECT(-443.462890625, -1177.7529296875, 5474.9814453125,
			2.0355552387937157e-13, -0.0, 0.0,
			/*BPARAM1*/ 0,
			/*BPARAM2*/ 3,
			/*BPARAM3*/ 0,
			/*BPARAM4*/ 0,
			...
			/*Event*/ NULL),
		REGION_OBJECT(598.462646484375, -1553.2607421875, 5320.318359375,
			2.0355552387937157e-13, -0.0, 0.0,
			/*BPARAM1*/ 0,
			/*BPARAM2*/ 0,
			/*BPARAM3*/ 0,
			/*BPARAM4*/ 0,
			/*MODEL ID*/ MODEL_RED_COIN,
			/*BEHAVIOR*/ bhvRedCoin,
			/*Event*/ NULL),
		REGION_OBJECT(303.87200927734375, -1553.2607421875, 5320.318359375,
			2.0355552387937157e-13, -0.0, 0.0,
			/*BPARAM1*/ 0,
			/*BPARAM2*/ 0,
			/*BPARAM3*/ 0,
			...
			/*BEHAVIOR*/ bhvRedCoin,
			/*Event*/ NULL),
		REGION_OBJECT(36.85731887817383, -1553.2607421875, 5320.318359375,
			2.0355552387937157e-13, -0.0, 0.0,
			/*BPARAM1*/ 0,
			/*BPARAM2*/ 0,
			/*BPARAM3*/ 0,
