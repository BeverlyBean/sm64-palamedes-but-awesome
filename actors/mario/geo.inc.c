...
const GeoLayout mario_geo_face_and_wings[] = {
   ...
   GEO_OPEN_NODE(),
      GEO_OPEN_NODE(),
         GEO_ASM(SSP_HEAD, geo_mario_special_shadow_part),
      GEO_CLOSE_NODE(),
...
const GeoLayout mario_geo_left_hand[] = {
   GEO_ASM(SSP_LEFT_HAND, geo_mario_special_shadow_part),
   GEO_OPEN_NODE(),
...
const GeoLayout mario_geo_right_hand[] = {
   GEO_ASM(SSP_RIGHT_HAND, geo_mario_special_shadow_part),
   GEO_OPEN_NODE(),
      ...
      GEO_OPEN_NODE(),
         ...
         GEO_OPEN_NODE(),
            GEO_ANIMATED_PART(LAYER_OPAQUE, 68, 0, 0, mario_torso),
                  GEO_OPEN_NODE(),
                     GEO_ASM(SSP_TORSO, geo_mario_special_shadow_part),
                  GEO_CLOSE_NODE(),
            GEO_OPEN_NODE(),
               ...
               GEO_OPEN_NODE(),
                  ...
                  GEO_OPEN_NODE(),
                     GEO_ASM(SSP_ARM_1_L, geo_mario_special_shadow_part),
                  GEO_CLOSE_NODE(),
                  GEO_OPEN_NODE(),
                     GEO_ANIMATED_PART(LAYER_OPAQUE, 65, 0, 0, mario_left_forearm_shared_dl),
                     GEO_OPEN_NODE(),
                        GEO_ASM(SSP_ARM_2_L, geo_mario_special_shadow_part),
                     GEO_CLOSE_NODE(),
                     GEO_OPEN_NODE(),
               ...
               GEO_OPEN_NODE(),
                  ...
                  GEO_OPEN_NODE(),
                     GEO_ASM(SSP_ARM_1_R, geo_mario_special_shadow_part),
                  GEO_CLOSE_NODE(),
                  GEO_OPEN_NODE(),
                     GEO_ANIMATED_PART(LAYER_OPAQUE, 65, 0, 0, mario_right_forearm_shared_dl),
                     GEO_OPEN_NODE(),
                        GEO_ASM(SSP_ARM_2_R, geo_mario_special_shadow_part),
                     GEO_CLOSE_NODE(),
                     GEO_OPEN_NODE(),
         ...
         GEO_OPEN_NODE(),
            ...
            GEO_OPEN_NODE(),
               GEO_ASM(SSP_LEG_1_R, geo_mario_special_shadow_part),
            GEO_CLOSE_NODE(),
            GEO_OPEN_NODE(),
               GEO_ANIMATED_PART(LAYER_OPAQUE, 89, 0, 0, mario_right_leg_shared_dl),
               GEO_OPEN_NODE(),
                  GEO_ASM(SSP_LEG_2_R, geo_mario_special_shadow_part),
               GEO_CLOSE_NODE(),
               GEO_OPEN_NODE(),
                  ...
                  GEO_OPEN_NODE(),
                     ...
                     GEO_SCALE(0x00, 65536),
                     GEO_OPEN_NODE(),
                        GEO_ASM(SSP_RIGHT_FOOT, geo_mario_special_shadow_part),
...
const GeoLayout mario_geo[] = {
   GEO_SHADOW(SHADOW_CIRCLE_PLAYER, 0xB4, 200),
   GEO_OPEN_NODE(),
